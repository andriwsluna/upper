...
import 'produto.pb.dart' as $0;
export 'produto.pb.dart';

class ProdutoServiceClient extends $grpc.Client {
  static final _$get = $grpc.ClientMethod<$0.GetRequest, $0.GetResponse>(
      '/static_grpc.produto.ProdutoService/get',
  ...
  static final _$select =
      $grpc.ClientMethod<$0.SelectRequest, $0.SelectResponse>(
          '/static_grpc.produto.ProdutoService/select',
  ...
  static final _$insert =
      $grpc.ClientMethod<$0.InsertRequest, $0.InsertResponse>(
          '/static_grpc.produto.ProdutoService/insert',
  ...
  static final _$update =
      $grpc.ClientMethod<$0.UpdateRequest, $0.UpdateResponse>(
          '/static_grpc.produto.ProdutoService/update',
  ...
  static final _$delete =
      $grpc.ClientMethod<$0.DeleteRequest, $0.DeleteResponse>(
          '/static_grpc.produto.ProdutoService/delete',
          ($0.DeleteRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.DeleteResponse.fromBuffer(value));

  ProdutoServiceClient($grpc.ClientChannel channel,
...
abstract class ProdutoServiceBase extends $grpc.Service {
  $core.String get $name => 'static_grpc.produto.ProdutoService';
