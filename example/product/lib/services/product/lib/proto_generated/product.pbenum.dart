...
class SelectableColumns extends $pb.ProtobufEnum {
  static const SelectableColumns allColumns = SelectableColumns._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'allColumns');
  static const SelectableColumns id = SelectableColumns._(1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'id');
  static const SelectableColumns code = SelectableColumns._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'code');
  static const SelectableColumns description = SelectableColumns._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'description');
  static const SelectableColumns isActive = SelectableColumns._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'isActive');
  static const SelectableColumns price = SelectableColumns._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'price');
  static const SelectableColumns fullDescription = SelectableColumns._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'fullDescription');
  static const SelectableColumns insertDate = SelectableColumns._(
      7,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'insertDate');
  static const SelectableColumns updateDate = SelectableColumns._(
      8,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'updateDate');
