...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode('CgpHZXRSZXF1ZXN0EhYKBmZpbG1JZBgBIAEoBVIGZmlsbUlk');
@$core.Deprecated('Use getResponseDescriptor instead')
const GetResponse$json = const {
  '1': 'GetResponse',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 8, '10': 'result'},
    const {'1': 'data', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.film.Film', '9': 0, '10': 'data'},
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode('CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBIsCgRkYXRhGAIgASgLMhYuc3RhdGljX2dycGMuZmlsbS5GaWxtSABSBGRhdGESJAoMZXJyb3JNZXNzYWdlGAMgASgJSABSDGVycm9yTWVzc2FnZUITChFHZXRSZXNwb25zZVJlc3VsdA==');
@$core.Deprecated('Use insertRequestDescriptor instead')
const InsertRequest$json = const {
  '1': 'InsertRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.film.FilmToInsert', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.film.InsertOptions', '10': 'options'},
  ],
};

/// Descriptor for `InsertRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode('Cg1JbnNlcnRSZXF1ZXN0EjIKBGRhdGEYASADKAsyHi5zdGF0aWNfZ3JwYy5maWxtLkZpbG1Ub0luc2VydFIEZGF0YRI5CgdvcHRpb25zGAIgASgLMh8uc3RhdGljX2dycGMuZmlsbS5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  '1': 'UpdateRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.film.Film', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.film.UpdateOptions', '10': 'options'},
  ],
};

/// Descriptor for `UpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode('Cg1VcGRhdGVSZXF1ZXN0EioKBGRhdGEYASADKAsyFi5zdGF0aWNfZ3JwYy5maWxtLkZpbG1SBGRhdGESOQoHb3B0aW9ucxgCIAEoCzIfLnN0YXRpY19ncnBjLmZpbG0uVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  '1': 'DeleteRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.film.FilmPk', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.film.DeleteOptions', '10': 'options'},
  ],
};

/// Descriptor for `DeleteRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode('Cg1EZWxldGVSZXF1ZXN0EiwKBGRhdGEYASADKAsyGC5zdGF0aWNfZ3JwYy5maWxtLkZpbG1Qa1IEZGF0YRI5CgdvcHRpb25zGAIgASgLMh8uc3RhdGljX2dycGMuZmlsbS5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  '1': 'SelectRequest',
  '2': const [
    const {'1': 'columns', '3': 1, '4': 3, '5': 14, '6': '.static_grpc.film.SelectableColumns', '10': 'columns'},
    const {'1': 'where', '3': 2, '4': 1, '5': 9, '10': 'where'},
    const {'1': 'orderBy', '3': 3, '4': 3, '5': 11, '6': '.static_grpc.film.OrderByOperator', '10': 'orderBy'},
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode('');
...
const SelectResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data', '3': 7, '4': 3, '5': 11, '6': '.static_grpc.film.Film', '10': 'data'},
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use filmDescriptor instead')
const Film$json = const {
  '1': 'Film',
  '2': const [
    const {'1': 'filmId', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'filmId'},
    const {'1': 'title', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'title'},
    const {'1': 'description', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'description'},
    const {'1': 'releaseYear', '3': 4, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'releaseYear'},
    const {'1': 'languageId', '3': 5, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'languageId'},
    const {'1': 'rentalDuration', '3': 6, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'rentalDuration'},
    const {'1': 'rentalRate', '3': 7, '4': 1, '5': 11, '6': '.static_grpc.film.NumericValue', '10': 'rentalRate'},
    const {'1': 'length', '3': 8, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'length'},
    const {'1': 'replacementCost', '3': 9, '4': 1, '5': 11, '6': '.static_grpc.film.NumericValue', '10': 'replacementCost'},
    const {'1': 'rating', '3': 10, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'rating'},
    const {'1': 'lastUpdate', '3': 11, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'lastUpdate'},
    const {'1': 'specialFeatures', '3': 12, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'specialFeatures'},
    const {'1': 'fulltext', '3': 13, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'fulltext'},
    const {'1': 'squares', '3': 14, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'squares'},
  ],
};

/// Descriptor for `Film`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List filmDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List filmPkDescriptor = $convert.base64Decode('CgZGaWxtUGsSNgoGZmlsbUlkGAEgASgLMh4uc3RhdGljX2dycGMuZmlsbS5JbnRlZ2VyVmFsdWVSBmZpbG1JZA==');
@$core.Deprecated('Use filmToInsertDescriptor instead')
const FilmToInsert$json = const {
  '1': 'FilmToInsert',
  '2': const [
    const {'1': 'title', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'title'},
    const {'1': 'description', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'description'},
    const {'1': 'releaseYear', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'releaseYear'},
    const {'1': 'languageId', '3': 4, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'languageId'},
    const {'1': 'rentalDuration', '3': 5, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'rentalDuration'},
    const {'1': 'rentalRate', '3': 6, '4': 1, '5': 11, '6': '.static_grpc.film.NumericValue', '10': 'rentalRate'},
    const {'1': 'length', '3': 7, '4': 1, '5': 11, '6': '.static_grpc.film.IntegerValue', '10': 'length'},
    const {'1': 'replacementCost', '3': 8, '4': 1, '5': 11, '6': '.static_grpc.film.NumericValue', '10': 'replacementCost'},
    const {'1': 'rating', '3': 9, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'rating'},
    const {'1': 'lastUpdate', '3': 10, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'lastUpdate'},
    const {'1': 'specialFeatures', '3': 11, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'specialFeatures'},
    const {'1': 'fulltext', '3': 12, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'fulltext'},
    const {'1': 'squares', '3': 13, '4': 1, '5': 11, '6': '.static_grpc.film.StringValue', '10': 'squares'},
  ],
};

/// Descriptor for `FilmToInsert`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List filmToInsertDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use orderByOperatorDescriptor instead')
const OrderByOperator$json = const {
  '1': 'OrderByOperator',
  '2': const [
    const {'1': 'column', '3': 1, '4': 1, '5': 14, '6': '.static_grpc.film.SelectableColumns', '10': 'column'},
    const {'1': 'orderType', '3': 2, '4': 1, '5': 14, '6': '.static_grpc.film.OrderType', '10': 'orderType'},
  ],
};

/// Descriptor for `OrderByOperator`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode('Cg9PcmRlckJ5T3BlcmF0b3ISOwoGY29sdW1uGAEgASgOMiMuc3RhdGljX2dycGMuZmlsbS5TZWxlY3RhYmxlQ29sdW1uc1IGY29sdW1uEjkKCW9yZGVyVHlwZRgCIAEoDjIbLnN0YXRpY19ncnBjLmZpbG0uT3JkZXJUeXBlUglvcmRlclR5cGU=');
