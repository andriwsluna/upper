...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASDgoKY3VzdG9tZXJJZBABEgsKB3N0b3JlSWQQAhINCglmaXJzdE5hbWUQAxIMCghsYXN0TmFtZRAEEgkKBWVtYWlsEAUSDQoJYWRkcmVzc0lkEAYSDgoKYWN0aXZlYm9vbBAHEg4KCmNyZWF0ZURhdGUQCBIOCgpsYXN0VXBkYXRlEAkSCgoGYWN0aXZlEAo=');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode(
    'CgpHZXRSZXF1ZXN0Eh4KCmN1c3RvbWVySWQYASABKAVSCmN1c3RvbWVySWQ=');
...
const GetResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.customer.Customer',
      '9': 0,
      '10': 'data'
    },
    const {
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBI0CgRkYXRhGAIgASgLMh4uc3RhdGljX2dycGMuY3VzdG9tZXIuQ3VzdG9tZXJIAFIEZGF0YRIkCgxlcnJvck1lc3NhZ2UYAyABKAlIAFIMZXJyb3JNZXNzYWdlQhMKEUdldFJlc3BvbnNlUmVzdWx0');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.customer.CustomerToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.customer.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0EjoKBGRhdGEYASADKAsyJi5zdGF0aWNfZ3JwYy5jdXN0b21lci5DdXN0b21lclRvSW5zZXJ0UgRkYXRhEj0KB29wdGlvbnMYAiABKAsyIy5zdGF0aWNfZ3JwYy5jdXN0b21lci5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.customer.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EjIKBGRhdGEYASADKAsyHi5zdGF0aWNfZ3JwYy5jdXN0b21lci5DdXN0b21lclIEZGF0YRI9CgdvcHRpb25zGAIgASgLMiMuc3RhdGljX2dycGMuY3VzdG9tZXIuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.customer.CustomerPk',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.customer.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0EjQKBGRhdGEYASADKAsyIC5zdGF0aWNfZ3JwYy5jdXN0b21lci5DdXN0b21lclBrUgRkYXRhEj0KB29wdGlvbnMYAiABKAsyIy5zdGF0aWNfZ3JwYy5jdXN0b21lci5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.customer.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.customer.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Customer$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.customer.IntegerValue',
      '10': 'customerId'
    },
    const {
      '1': 'storeId',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.customer.StringValue',
      '10': 'firstName'
    },
    const {
      '1': 'lastName',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.customer.BooleanValue',
      '10': 'activebool'
    },
    const {
      '1': 'createDate',
...
final $typed_data.Uint8List customerDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List customerPkDescriptor = $convert.base64Decode(
    'CgpDdXN0b21lclBrEkIKCmN1c3RvbWVySWQYASABKAsyIi5zdGF0aWNfZ3JwYy5jdXN0b21lci5JbnRlZ2VyVmFsdWVSCmN1c3RvbWVySWQ=');
...
final $typed_data.Uint8List customerToInsertDescriptor = $convert.base64Decode(
    '');
...
const OrderByOperator$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.static_grpc.customer.OrderType',
      '10': 'orderType'
    },
  ],
};
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISPwoGY29sdW1uGAEgASgOMicuc3RhdGljX2dycGMuY3VzdG9tZXIuU2VsZWN0YWJsZUNvbHVtbnNSBmNvbHVtbhI9CglvcmRlclR5cGUYAiABKA4yHy5zdGF0aWNfZ3JwYy5jdXN0b21lci5PcmRlclR5cGVSCW9yZGVyVHlwZQ==');
