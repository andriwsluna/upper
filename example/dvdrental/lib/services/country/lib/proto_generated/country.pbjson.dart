...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASDQoJY291bnRyeUlkEAESCwoHY291bnRyeRACEg4KCmxhc3RVcGRhdGUQAw==');
...
final $typed_data.Uint8List getRequestDescriptor = $convert
    .base64Decode('CgpHZXRSZXF1ZXN0EhwKCWNvdW50cnlJZBgBIAEoBVIJY291bnRyeUlk');
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBIyCgRkYXRhGAIgASgLMhwuc3RhdGljX2dycGMuY291bnRyeS5Db3VudHJ5SABSBGRhdGESJAoMZXJyb3JNZXNzYWdlGAMgASgJSABSDGVycm9yTWVzc2FnZUITChFHZXRSZXNwb25zZVJlc3VsdA==');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.country.CountryToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.country.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0EjgKBGRhdGEYASADKAsyJC5zdGF0aWNfZ3JwYy5jb3VudHJ5LkNvdW50cnlUb0luc2VydFIEZGF0YRI8CgdvcHRpb25zGAIgASgLMiIuc3RhdGljX2dycGMuY291bnRyeS5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.country.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EjAKBGRhdGEYASADKAsyHC5zdGF0aWNfZ3JwYy5jb3VudHJ5LkNvdW50cnlSBGRhdGESPAoHb3B0aW9ucxgCIAEoCzIiLnN0YXRpY19ncnBjLmNvdW50cnkuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.country.CountryPk',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.country.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0EjIKBGRhdGEYASADKAsyHi5zdGF0aWNfZ3JwYy5jb3VudHJ5LkNvdW50cnlQa1IEZGF0YRI8CgdvcHRpb25zGAIgASgLMiIuc3RhdGljX2dycGMuY291bnRyeS5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.country.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.country.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Country$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.country.IntegerValue',
      '10': 'countryId'
    },
    const {
      '1': 'country',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.country.StringValue',
      '10': 'country'
    },
    const {
      '1': 'lastUpdate',
...
final $typed_data.Uint8List countryDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List countryPkDescriptor = $convert.base64Decode(
    'CglDb3VudHJ5UGsSPwoJY291bnRyeUlkGAEgASgLMiEuc3RhdGljX2dycGMuY291bnRyeS5JbnRlZ2VyVmFsdWVSCWNvdW50cnlJZA==');
...
final $typed_data.Uint8List countryToInsertDescriptor = $convert.base64Decode(
    'Cg9Db3VudHJ5VG9JbnNlcnQSOgoHY291bnRyeRgBIAEoCzIgLnN0YXRpY19ncnBjLmNvdW50cnkuU3RyaW5nVmFsdWVSB2NvdW50cnkSQAoKbGFzdFVwZGF0ZRgCIAEoCzIgLnN0YXRpY19ncnBjLmNvdW50cnkuU3RyaW5nVmFsdWVSCmxhc3RVcGRhdGU=');
...
const OrderByOperator$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.static_grpc.country.OrderType',
      '10': 'orderType'
    },
  ],
};
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISPgoGY29sdW1uGAEgASgOMiYuc3RhdGljX2dycGMuY291bnRyeS5TZWxlY3RhYmxlQ29sdW1uc1IGY29sdW1uEjwKCW9yZGVyVHlwZRgCIAEoDjIeLnN0YXRpY19ncnBjLmNvdW50cnkuT3JkZXJUeXBlUglvcmRlclR5cGU=');
