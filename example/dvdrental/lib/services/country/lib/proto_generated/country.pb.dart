  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<CountryToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: CountryToInsert.create)
    ..aOM<InsertOptions>(
...
class Country extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryId',
        protoName: 'countryId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'country',
...
class CountryPk extends $pb.GeneratedMessage {
  ...
  factory CountryPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CountryPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CountryPk copyWith(void Function(CountryPk) updates) =>
      super.copyWith((message) => updates(message as CountryPk))
          as CountryPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CountryPk getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CountryPk>(create);
...
class CountryToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<StringValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'country',
        subBuilder: StringValue.create)
    ..aOM<StringValue>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
  ...
  factory CountryToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CountryToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CountryToInsert copyWith(void Function(CountryToInsert) updates) =>
      super.copyWith((message) => updates(message as CountryToInsert))
          as CountryToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CountryToInsert create() => CountryToInsert._();
  CountryToInsert createEmptyInstance() => create();
  static $pb.PbList<CountryToInsert> createRepeated() =>
      $pb.PbList<CountryToInsert>();
  @$core.pragma('dart2js:noInline')
  static CountryToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CountryToInsert>(create);
