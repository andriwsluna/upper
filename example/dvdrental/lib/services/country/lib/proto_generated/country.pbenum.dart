...
class SelectableColumns extends $pb.ProtobufEnum {
  ...
  static const SelectableColumns countryId = SelectableColumns._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'countryId');
  static const SelectableColumns country = SelectableColumns._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'country');
  static const SelectableColumns lastUpdate = SelectableColumns._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'lastUpdate');
