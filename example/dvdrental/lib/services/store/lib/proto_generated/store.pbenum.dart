...
class SelectableColumns extends $pb.ProtobufEnum {
  ...
  static const SelectableColumns storeId = SelectableColumns._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'storeId');
  static const SelectableColumns managerStaffId = SelectableColumns._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'managerStaffId');
  static const SelectableColumns addressId = SelectableColumns._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'addressId');
