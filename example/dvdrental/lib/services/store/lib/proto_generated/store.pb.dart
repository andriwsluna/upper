  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<StoreToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: StoreToInsert.create)
    ..aOM<InsertOptions>(
...
class Store extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Store',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.store'),
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storeId',
        protoName: 'storeId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managerStaffId',
        protoName: 'managerStaffId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressId',
        protoName: 'addressId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdate',
  ...
  @$pb.TagNumber(2)
  set managerStaffId(IntegerValue v) {
    setField(2, v);
  }
...
class StorePk extends $pb.GeneratedMessage {
  ...
  factory StorePk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StorePk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  StorePk copyWith(void Function(StorePk) updates) =>
      super.copyWith((message) => updates(message as StorePk))
          as StorePk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static StorePk getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StorePk>(create);
...
class StoreToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managerStaffId',
        protoName: 'managerStaffId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressId',
        protoName: 'addressId', subBuilder: IntegerValue.create)
  ...
  factory StoreToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StoreToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  StoreToInsert copyWith(void Function(StoreToInsert) updates) =>
      super.copyWith((message) => updates(message as StoreToInsert))
          as StoreToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StoreToInsert create() => StoreToInsert._();
  StoreToInsert createEmptyInstance() => create();
  static $pb.PbList<StoreToInsert> createRepeated() =>
      $pb.PbList<StoreToInsert>();
  @$core.pragma('dart2js:noInline')
  static StoreToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<StoreToInsert>(create);
