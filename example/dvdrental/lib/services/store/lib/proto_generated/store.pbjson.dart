...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASCwoHc3RvcmVJZBABEhIKDm1hbmFnZXJTdGFmZklkEAISDQoJYWRkcmVzc0lkEAMSDgoKbGFzdFVwZGF0ZRAE');
...
final $typed_data.Uint8List getRequestDescriptor = $convert
    .base64Decode('CgpHZXRSZXF1ZXN0EhgKB3N0b3JlSWQYASABKAVSB3N0b3JlSWQ=');
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBIuCgRkYXRhGAIgASgLMhguc3RhdGljX2dycGMuc3RvcmUuU3RvcmVIAFIEZGF0YRIkCgxlcnJvck1lc3NhZ2UYAyABKAlIAFIMZXJyb3JNZXNzYWdlQhMKEUdldFJlc3BvbnNlUmVzdWx0');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.store.StoreToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.store.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0EjQKBGRhdGEYASADKAsyIC5zdGF0aWNfZ3JwYy5zdG9yZS5TdG9yZVRvSW5zZXJ0UgRkYXRhEjoKB29wdGlvbnMYAiABKAsyIC5zdGF0aWNfZ3JwYy5zdG9yZS5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.store.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EiwKBGRhdGEYASADKAsyGC5zdGF0aWNfZ3JwYy5zdG9yZS5TdG9yZVIEZGF0YRI6CgdvcHRpb25zGAIgASgLMiAuc3RhdGljX2dycGMuc3RvcmUuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.store.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0Ei4KBGRhdGEYASADKAsyGi5zdGF0aWNfZ3JwYy5zdG9yZS5TdG9yZVBrUgRkYXRhEjoKB29wdGlvbnMYAiABKAsyIC5zdGF0aWNfZ3JwYy5zdG9yZS5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.store.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.store.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Store$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.store.IntegerValue',
      '10': 'storeId'
    },
    const {
      '1': 'managerStaffId',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.store.StringValue',
      '10': 'lastUpdate'
    },
  ],
};
...
final $typed_data.Uint8List storeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List storePkDescriptor = $convert.base64Decode(
    'CgdTdG9yZVBrEjkKB3N0b3JlSWQYASABKAsyHy5zdGF0aWNfZ3JwYy5zdG9yZS5JbnRlZ2VyVmFsdWVSB3N0b3JlSWQ=');
...
final $typed_data.Uint8List storeToInsertDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISPAoGY29sdW1uGAEgASgOMiQuc3RhdGljX2dycGMuc3RvcmUuU2VsZWN0YWJsZUNvbHVtbnNSBmNvbHVtbhI6CglvcmRlclR5cGUYAiABKA4yHC5zdGF0aWNfZ3JwYy5zdG9yZS5PcmRlclR5cGVSCW9yZGVyVHlwZQ==');
