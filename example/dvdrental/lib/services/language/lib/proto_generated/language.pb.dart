  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<LanguageToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: LanguageToInsert.create)
    ..aOM<InsertOptions>(
...
class Language extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageId',
...
class LanguagePk extends $pb.GeneratedMessage {
  ...
  factory LanguagePk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LanguagePk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LanguagePk copyWith(void Function(LanguagePk) updates) =>
      super.copyWith((message) => updates(message as LanguagePk))
          as LanguagePk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static LanguagePk getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LanguagePk>(create);
...
class LanguageToInsert extends $pb.GeneratedMessage {
  ...
  factory LanguageToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LanguageToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LanguageToInsert copyWith(void Function(LanguageToInsert) updates) =>
      super.copyWith((message) => updates(message as LanguageToInsert))
          as LanguageToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static LanguageToInsert create() => LanguageToInsert._();
  LanguageToInsert createEmptyInstance() => create();
  static $pb.PbList<LanguageToInsert> createRepeated() =>
      $pb.PbList<LanguageToInsert>();
  @$core.pragma('dart2js:noInline')
  static LanguageToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LanguageToInsert>(create);
