...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASDgoKbGFuZ3VhZ2VJZBABEgkKBW5hbWVfEAISDgoKbGFzdFVwZGF0ZRAD');
...
const GetRequest$json = const {
  '1': 'GetRequest',
  '2': const [
    const {'1': 'languageId', '3': 1, '4': 1, '5': 5, '10': 'languageId'},
  ],
};

/// Descriptor for `GetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode(
    'CgpHZXRSZXF1ZXN0Eh4KCmxhbmd1YWdlSWQYASABKAVSCmxhbmd1YWdlSWQ=');
...
const GetResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.language.Language',
      '9': 0,
      '10': 'data'
    },
    const {
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBI0CgRkYXRhGAIgASgLMh4uc3RhdGljX2dycGMubGFuZ3VhZ2UuTGFuZ3VhZ2VIAFIEZGF0YRIkCgxlcnJvck1lc3NhZ2UYAyABKAlIAFIMZXJyb3JNZXNzYWdlQhMKEUdldFJlc3BvbnNlUmVzdWx0');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.language.LanguageToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.language.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0EjoKBGRhdGEYASADKAsyJi5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5MYW5ndWFnZVRvSW5zZXJ0UgRkYXRhEj0KB29wdGlvbnMYAiABKAsyIy5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.language.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EjIKBGRhdGEYASADKAsyHi5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5MYW5ndWFnZVIEZGF0YRI9CgdvcHRpb25zGAIgASgLMiMuc3RhdGljX2dycGMubGFuZ3VhZ2UuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.language.LanguagePk',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.language.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0EjQKBGRhdGEYASADKAsyIC5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5MYW5ndWFnZVBrUgRkYXRhEj0KB29wdGlvbnMYAiABKAsyIy5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.language.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.language.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Language$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.language.IntegerValue',
      '10': 'languageId'
    },
    const {
      '1': 'name',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.language.StringValue',
      '10': 'name'
    },
    const {
      '1': 'lastUpdate',
...
final $typed_data.Uint8List languageDescriptor = $convert.base64Decode(
    '');
@$core.Deprecated('Use languagePkDescriptor instead')
const LanguagePk$json = const {
  '1': 'LanguagePk',
  '2': const [
    const {
      '1': 'languageId',
...
/// Descriptor for `LanguagePk`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List languagePkDescriptor = $convert.base64Decode(
    'CgpMYW5ndWFnZVBrEkIKCmxhbmd1YWdlSWQYASABKAsyIi5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5JbnRlZ2VyVmFsdWVSCmxhbmd1YWdlSWQ=');
@$core.Deprecated('Use languageToInsertDescriptor instead')
const LanguageToInsert$json = const {
  '1': 'LanguageToInsert',
  '2': const [
    const {
      '1': 'name',
...
/// Descriptor for `LanguageToInsert`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List languageToInsertDescriptor = $convert.base64Decode(
    'ChBMYW5ndWFnZVRvSW5zZXJ0EjUKBG5hbWUYASABKAsyIS5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5TdHJpbmdWYWx1ZVIEbmFtZRJBCgpsYXN0VXBkYXRlGAIgASgLMiEuc3RhdGljX2dycGMubGFuZ3VhZ2UuU3RyaW5nVmFsdWVSCmxhc3RVcGRhdGU=');
...
const OrderByOperator$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.static_grpc.language.OrderType',
      '10': 'orderType'
    },
  ],
};
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISPwoGY29sdW1uGAEgASgOMicuc3RhdGljX2dycGMubGFuZ3VhZ2UuU2VsZWN0YWJsZUNvbHVtbnNSBmNvbHVtbhI9CglvcmRlclR5cGUYAiABKA4yHy5zdGF0aWNfZ3JwYy5sYW5ndWFnZS5PcmRlclR5cGVSCW9yZGVyVHlwZQ==');
