...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASDQoJcGF5bWVudElkEAESDgoKY3VzdG9tZXJJZBACEgsKB3N0YWZmSWQQAxIMCghyZW50YWxJZBAEEgoKBmFtb3VudBAFEg8KC3BheW1lbnREYXRlEAY=');
...
final $typed_data.Uint8List getRequestDescriptor = $convert
    .base64Decode('CgpHZXRSZXF1ZXN0EhwKCXBheW1lbnRJZBgBIAEoBVIJcGF5bWVudElk');
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBIyCgRkYXRhGAIgASgLMhwuc3RhdGljX2dycGMucGF5bWVudC5QYXltZW50SABSBGRhdGESJAoMZXJyb3JNZXNzYWdlGAMgASgJSABSDGVycm9yTWVzc2FnZUITChFHZXRSZXNwb25zZVJlc3VsdA==');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.payment.PaymentToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.payment.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0EjgKBGRhdGEYASADKAsyJC5zdGF0aWNfZ3JwYy5wYXltZW50LlBheW1lbnRUb0luc2VydFIEZGF0YRI8CgdvcHRpb25zGAIgASgLMiIuc3RhdGljX2dycGMucGF5bWVudC5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.payment.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EjAKBGRhdGEYASADKAsyHC5zdGF0aWNfZ3JwYy5wYXltZW50LlBheW1lbnRSBGRhdGESPAoHb3B0aW9ucxgCIAEoCzIiLnN0YXRpY19ncnBjLnBheW1lbnQuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.payment.PaymentPk',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.payment.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0EjIKBGRhdGEYASADKAsyHi5zdGF0aWNfZ3JwYy5wYXltZW50LlBheW1lbnRQa1IEZGF0YRI8CgdvcHRpb25zGAIgASgLMiIuc3RhdGljX2dycGMucGF5bWVudC5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.payment.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.payment.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Payment$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.payment.IntegerValue',
      '10': 'paymentId'
    },
    const {
      '1': 'customerId',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.payment.NumericValue',
      '10': 'amount'
    },
    const {
      '1': 'paymentDate',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.payment.StringValue',
      '10': 'paymentDate'
    },
  ],
};
...
final $typed_data.Uint8List paymentDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List paymentPkDescriptor = $convert.base64Decode(
    'CglQYXltZW50UGsSPwoJcGF5bWVudElkGAEgASgLMiEuc3RhdGljX2dycGMucGF5bWVudC5JbnRlZ2VyVmFsdWVSCXBheW1lbnRJZA==');
...
final $typed_data.Uint8List paymentToInsertDescriptor = $convert.base64Decode(
    '');
...
const OrderByOperator$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.static_grpc.payment.OrderType',
      '10': 'orderType'
    },
  ],
};
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISPgoGY29sdW1uGAEgASgOMiYuc3RhdGljX2dycGMucGF5bWVudC5TZWxlY3RhYmxlQ29sdW1uc1IGY29sdW1uEjwKCW9yZGVyVHlwZRgCIAEoDjIeLnN0YXRpY19ncnBjLnBheW1lbnQuT3JkZXJUeXBlUglvcmRlclR5cGU=');
