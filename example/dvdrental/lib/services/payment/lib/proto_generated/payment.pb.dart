  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<PaymentToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: PaymentToInsert.create)
    ..aOM<InsertOptions>(
...
class Payment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Payment',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.payment'),
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentId',
        protoName: 'paymentId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId',
        protoName: 'customerId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staffId',
        protoName: 'staffId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rentalId',
        protoName: 'rentalId', subBuilder: IntegerValue.create)
...
class PaymentPk extends $pb.GeneratedMessage {
  ...
  factory PaymentPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PaymentPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PaymentPk copyWith(void Function(PaymentPk) updates) =>
      super.copyWith((message) => updates(message as PaymentPk))
          as PaymentPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PaymentPk getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PaymentPk>(create);
...
class PaymentToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentToInsert',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.payment'),
      createEmptyInstance: create)
    ..aOM<IntegerValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId',
        protoName: 'customerId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staffId',
        protoName: 'staffId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rentalId',
        protoName: 'rentalId', subBuilder: IntegerValue.create)
    ..aOM<NumericValue>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount',
        subBuilder: NumericValue.create)
    ..aOM<StringValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentDate',
        protoName: 'paymentDate', subBuilder: StringValue.create)
    ..hasRequiredFields = false;
  ...
  factory PaymentToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PaymentToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PaymentToInsert copyWith(void Function(PaymentToInsert) updates) =>
      super.copyWith((message) => updates(message as PaymentToInsert))
          as PaymentToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PaymentToInsert create() => PaymentToInsert._();
  PaymentToInsert createEmptyInstance() => create();
  static $pb.PbList<PaymentToInsert> createRepeated() =>
      $pb.PbList<PaymentToInsert>();
  @$core.pragma('dart2js:noInline')
  static PaymentToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PaymentToInsert>(create);
