  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<ActorToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: ActorToInsert.create)
    ..aOM<InsertOptions>(
...
class Actor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Actor',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.actor'),
...
class ActorPk extends $pb.GeneratedMessage {
  ...
  factory ActorPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ActorPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ActorPk copyWith(void Function(ActorPk) updates) =>
      super.copyWith((message) => updates(message as ActorPk))
          as ActorPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ActorPk getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ActorPk>(create);
...
class ActorToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<StringValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firstName',
        protoName: 'firstName', subBuilder: StringValue.create)
    ..aOM<StringValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastName',
        protoName: 'lastName', subBuilder: StringValue.create)
    ..aOM<StringValue>(
  ...
  factory ActorToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ActorToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ActorToInsert copyWith(void Function(ActorToInsert) updates) =>
      super.copyWith((message) => updates(message as ActorToInsert))
          as ActorToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ActorToInsert create() => ActorToInsert._();
  ActorToInsert createEmptyInstance() => create();
  static $pb.PbList<ActorToInsert> createRepeated() =>
      $pb.PbList<ActorToInsert>();
  @$core.pragma('dart2js:noInline')
  static ActorToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ActorToInsert>(create);
