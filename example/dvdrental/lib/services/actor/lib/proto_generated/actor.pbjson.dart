...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode('ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASCwoHYWN0b3JJZBABEg0KCWZpcnN0TmFtZRACEgwKCGxhc3ROYW1lEAMSDgoKbGFzdFVwZGF0ZRAE');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode('CgpHZXRSZXF1ZXN0EhgKB2FjdG9ySWQYASABKAVSB2FjdG9ySWQ=');
@$core.Deprecated('Use getResponseDescriptor instead')
const GetResponse$json = const {
  '1': 'GetResponse',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 8, '10': 'result'},
    const {'1': 'data', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.actor.Actor', '9': 0, '10': 'data'},
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode('CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBIuCgRkYXRhGAIgASgLMhguc3RhdGljX2dycGMuYWN0b3IuQWN0b3JIAFIEZGF0YRIkCgxlcnJvck1lc3NhZ2UYAyABKAlIAFIMZXJyb3JNZXNzYWdlQhMKEUdldFJlc3BvbnNlUmVzdWx0');
@$core.Deprecated('Use insertRequestDescriptor instead')
const InsertRequest$json = const {
  '1': 'InsertRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.actor.ActorToInsert', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.actor.InsertOptions', '10': 'options'},
  ],
};

/// Descriptor for `InsertRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode('Cg1JbnNlcnRSZXF1ZXN0EjQKBGRhdGEYASADKAsyIC5zdGF0aWNfZ3JwYy5hY3Rvci5BY3RvclRvSW5zZXJ0UgRkYXRhEjoKB29wdGlvbnMYAiABKAsyIC5zdGF0aWNfZ3JwYy5hY3Rvci5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  '1': 'UpdateRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.actor.Actor', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.actor.UpdateOptions', '10': 'options'},
  ],
};

/// Descriptor for `UpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode('Cg1VcGRhdGVSZXF1ZXN0EiwKBGRhdGEYASADKAsyGC5zdGF0aWNfZ3JwYy5hY3Rvci5BY3RvclIEZGF0YRI6CgdvcHRpb25zGAIgASgLMiAuc3RhdGljX2dycGMuYWN0b3IuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  '1': 'DeleteRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.actor.ActorPk', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.actor.DeleteOptions', '10': 'options'},
  ],
};

/// Descriptor for `DeleteRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode('Cg1EZWxldGVSZXF1ZXN0Ei4KBGRhdGEYASADKAsyGi5zdGF0aWNfZ3JwYy5hY3Rvci5BY3RvclBrUgRkYXRhEjoKB29wdGlvbnMYAiABKAsyIC5zdGF0aWNfZ3JwYy5hY3Rvci5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  '1': 'SelectRequest',
  '2': const [
    const {'1': 'columns', '3': 1, '4': 3, '5': 14, '6': '.static_grpc.actor.SelectableColumns', '10': 'columns'},
    const {'1': 'where', '3': 2, '4': 1, '5': 9, '10': 'where'},
    const {'1': 'orderBy', '3': 3, '4': 3, '5': 11, '6': '.static_grpc.actor.OrderByOperator', '10': 'orderBy'},
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode('');
...
const SelectResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data', '3': 7, '4': 3, '5': 11, '6': '.static_grpc.actor.Actor', '10': 'data'},
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use actorDescriptor instead')
const Actor$json = const {
  '1': 'Actor',
  '2': const [
    const {'1': 'actorId', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.actor.IntegerValue', '10': 'actorId'},
    const {'1': 'firstName', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.actor.StringValue', '10': 'firstName'},
    const {'1': 'lastName', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.actor.StringValue', '10': 'lastName'},
    const {'1': 'lastUpdate', '3': 4, '4': 1, '5': 11, '6': '.static_grpc.actor.StringValue', '10': 'lastUpdate'},
  ],
};

/// Descriptor for `Actor`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List actorDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List actorPkDescriptor = $convert.base64Decode('CgdBY3RvclBrEjkKB2FjdG9ySWQYASABKAsyHy5zdGF0aWNfZ3JwYy5hY3Rvci5JbnRlZ2VyVmFsdWVSB2FjdG9ySWQ=');
@$core.Deprecated('Use actorToInsertDescriptor instead')
const ActorToInsert$json = const {
  '1': 'ActorToInsert',
  '2': const [
    const {'1': 'firstName', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.actor.StringValue', '10': 'firstName'},
    const {'1': 'lastName', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.actor.StringValue', '10': 'lastName'},
    const {'1': 'lastUpdate', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.actor.StringValue', '10': 'lastUpdate'},
  ],
};

/// Descriptor for `ActorToInsert`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List actorToInsertDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use orderByOperatorDescriptor instead')
const OrderByOperator$json = const {
  '1': 'OrderByOperator',
  '2': const [
    const {'1': 'column', '3': 1, '4': 1, '5': 14, '6': '.static_grpc.actor.SelectableColumns', '10': 'column'},
    const {'1': 'orderType', '3': 2, '4': 1, '5': 14, '6': '.static_grpc.actor.OrderType', '10': 'orderType'},
  ],
};

/// Descriptor for `OrderByOperator`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode('Cg9PcmRlckJ5T3BlcmF0b3ISPAoGY29sdW1uGAEgASgOMiQuc3RhdGljX2dycGMuYWN0b3IuU2VsZWN0YWJsZUNvbHVtbnNSBmNvbHVtbhI6CglvcmRlclR5cGUYAiABKA4yHC5zdGF0aWNfZ3JwYy5hY3Rvci5PcmRlclR5cGVSCW9yZGVyVHlwZQ==');
