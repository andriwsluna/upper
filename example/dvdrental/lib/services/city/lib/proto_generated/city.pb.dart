  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'result')
    ..aOM<City>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data',
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<CityToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: CityToInsert.create)
    ..aOM<InsertOptions>(
...
class City extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'City',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.city'),
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cityId',
        protoName: 'cityId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'city',
        subBuilder: StringValue.create)
    ..aOM<IntegerValue>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryId',
        protoName: 'countryId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(
  ...
  City copyWith(void Function(City) updates) =>
      super.copyWith((message) => updates(message as City))
          as City; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CityPk extends $pb.GeneratedMessage {
  ...
  factory CityPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CityPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CityPk copyWith(void Function(CityPk) updates) =>
      super.copyWith((message) => updates(message as CityPk))
          as CityPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CityPk getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CityPk>(create);
...
class CityToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'static_grpc.city'),
      createEmptyInstance: create)
    ..aOM<StringValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'city',
        subBuilder: StringValue.create)
    ..aOM<IntegerValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryId',
        protoName: 'countryId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdate',
        protoName: 'lastUpdate', subBuilder: StringValue.create)
    ..hasRequiredFields = false;
  ...
  factory CityToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CityToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CityToInsert copyWith(void Function(CityToInsert) updates) =>
      super.copyWith((message) => updates(message as CityToInsert))
          as CityToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CityToInsert create() => CityToInsert._();
  CityToInsert createEmptyInstance() => create();
  static $pb.PbList<CityToInsert> createRepeated() =>
      $pb.PbList<CityToInsert>();
  @$core.pragma('dart2js:noInline')
  static CityToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CityToInsert>(create);
