...
class SelectableColumns extends $pb.ProtobufEnum {
  ...
  static const SelectableColumns cityId = SelectableColumns._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'cityId');
  static const SelectableColumns city = SelectableColumns._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'city');
  static const SelectableColumns countryId = SelectableColumns._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'countryId');
