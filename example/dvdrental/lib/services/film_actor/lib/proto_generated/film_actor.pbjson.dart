...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASCwoHYWN0b3JJZBABEgoKBmZpbG1JZBACEg4KCmxhc3RVcGRhdGUQAw==');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode(
    'CgpHZXRSZXF1ZXN0EhgKB2FjdG9ySWQYASABKAVSB2FjdG9ySWQSFgoGZmlsbUlkGAIgASgFUgZmaWxtSWQ=');
...
const GetResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_actor.Film_actor',
      '9': 0,
      '10': 'data'
    },
    const {
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBI4CgRkYXRhGAIgASgLMiIuc3RhdGljX2dycGMuZmlsbV9hY3Rvci5GaWxtX2FjdG9ySABSBGRhdGESJAoMZXJyb3JNZXNzYWdlGAMgASgJSABSDGVycm9yTWVzc2FnZUITChFHZXRSZXNwb25zZVJlc3VsdA==');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.film_actor.Film_actorToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_actor.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0Ej4KBGRhdGEYASADKAsyKi5zdGF0aWNfZ3JwYy5maWxtX2FjdG9yLkZpbG1fYWN0b3JUb0luc2VydFIEZGF0YRI/CgdvcHRpb25zGAIgASgLMiUuc3RhdGljX2dycGMuZmlsbV9hY3Rvci5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_actor.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EjYKBGRhdGEYASADKAsyIi5zdGF0aWNfZ3JwYy5maWxtX2FjdG9yLkZpbG1fYWN0b3JSBGRhdGESPwoHb3B0aW9ucxgCIAEoCzIlLnN0YXRpY19ncnBjLmZpbG1fYWN0b3IuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.film_actor.Film_actorPk',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_actor.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0EjgKBGRhdGEYASADKAsyJC5zdGF0aWNfZ3JwYy5maWxtX2FjdG9yLkZpbG1fYWN0b3JQa1IEZGF0YRI/CgdvcHRpb25zGAIgASgLMiUuc3RhdGljX2dycGMuZmlsbV9hY3Rvci5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.film_actor.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.film_actor.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Film_actor$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_actor.IntegerValue',
      '10': 'actorId'
    },
    const {
      '1': 'filmId',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_actor.StringValue',
      '10': 'lastUpdate'
    },
  ],
};
...
final $typed_data.Uint8List film_actorDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List film_actorPkDescriptor = $convert.base64Decode(
    'CgxGaWxtX2FjdG9yUGsSPgoHYWN0b3JJZBgBIAEoCzIkLnN0YXRpY19ncnBjLmZpbG1fYWN0b3IuSW50ZWdlclZhbHVlUgdhY3RvcklkEjwKBmZpbG1JZBgCIAEoCzIkLnN0YXRpY19ncnBjLmZpbG1fYWN0b3IuSW50ZWdlclZhbHVlUgZmaWxtSWQ=');
...
final $typed_data.Uint8List film_actorToInsertDescriptor = $convert.base64Decode(
    '');
...
const OrderByOperator$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.static_grpc.film_actor.OrderType',
      '10': 'orderType'
    },
  ],
};
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISQQoGY29sdW1uGAEgASgOMikuc3RhdGljX2dycGMuZmlsbV9hY3Rvci5TZWxlY3RhYmxlQ29sdW1uc1IGY29sdW1uEj8KCW9yZGVyVHlwZRgCIAEoDjIhLnN0YXRpY19ncnBjLmZpbG1fYWN0b3IuT3JkZXJUeXBlUglvcmRlclR5cGU=');
