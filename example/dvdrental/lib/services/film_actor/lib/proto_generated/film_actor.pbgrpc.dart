...
import 'film_actor.pb.dart' as $0;
export 'film_actor.pb.dart';

class Film_actorServiceClient extends $grpc.Client {
  static final _$get = $grpc.ClientMethod<$0.GetRequest, $0.GetResponse>(
      '/static_grpc.film_actor.Film_actorService/get',
  ...
  static final _$select =
      $grpc.ClientMethod<$0.SelectRequest, $0.SelectResponse>(
          '/static_grpc.film_actor.Film_actorService/select',
  ...
  static final _$insert =
      $grpc.ClientMethod<$0.InsertRequest, $0.InsertResponse>(
          '/static_grpc.film_actor.Film_actorService/insert',
  ...
  static final _$update =
      $grpc.ClientMethod<$0.UpdateRequest, $0.UpdateResponse>(
          '/static_grpc.film_actor.Film_actorService/update',
  ...
  static final _$delete =
      $grpc.ClientMethod<$0.DeleteRequest, $0.DeleteResponse>(
          '/static_grpc.film_actor.Film_actorService/delete',
          ($0.DeleteRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.DeleteResponse.fromBuffer(value));

  Film_actorServiceClient($grpc.ClientChannel channel,
...
abstract class Film_actorServiceBase extends $grpc.Service {
  $core.String get $name => 'static_grpc.film_actor.Film_actorService';

  Film_actorServiceBase() {
