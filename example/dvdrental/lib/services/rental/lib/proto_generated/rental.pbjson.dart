...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode('ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASDAoIcmVudGFsSWQQARIOCgpyZW50YWxEYXRlEAISDwoLaW52ZW50b3J5SWQQAxIOCgpjdXN0b21lcklkEAQSDgoKcmV0dXJuRGF0ZRAFEgsKB3N0YWZmSWQQBhIOCgpsYXN0VXBkYXRlEAc=');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode('CgpHZXRSZXF1ZXN0EhoKCHJlbnRhbElkGAEgASgFUghyZW50YWxJZA==');
@$core.Deprecated('Use getResponseDescriptor instead')
const GetResponse$json = const {
  '1': 'GetResponse',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 8, '10': 'result'},
    const {'1': 'data', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.rental.Rental', '9': 0, '10': 'data'},
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode('CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBIwCgRkYXRhGAIgASgLMhouc3RhdGljX2dycGMucmVudGFsLlJlbnRhbEgAUgRkYXRhEiQKDGVycm9yTWVzc2FnZRgDIAEoCUgAUgxlcnJvck1lc3NhZ2VCEwoRR2V0UmVzcG9uc2VSZXN1bHQ=');
@$core.Deprecated('Use insertRequestDescriptor instead')
const InsertRequest$json = const {
  '1': 'InsertRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.rental.RentalToInsert', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.rental.InsertOptions', '10': 'options'},
  ],
};

/// Descriptor for `InsertRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode('Cg1JbnNlcnRSZXF1ZXN0EjYKBGRhdGEYASADKAsyIi5zdGF0aWNfZ3JwYy5yZW50YWwuUmVudGFsVG9JbnNlcnRSBGRhdGESOwoHb3B0aW9ucxgCIAEoCzIhLnN0YXRpY19ncnBjLnJlbnRhbC5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  '1': 'UpdateRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.rental.Rental', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.rental.UpdateOptions', '10': 'options'},
  ],
};

/// Descriptor for `UpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode('Cg1VcGRhdGVSZXF1ZXN0Ei4KBGRhdGEYASADKAsyGi5zdGF0aWNfZ3JwYy5yZW50YWwuUmVudGFsUgRkYXRhEjsKB29wdGlvbnMYAiABKAsyIS5zdGF0aWNfZ3JwYy5yZW50YWwuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  '1': 'DeleteRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.rental.RentalPk', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.rental.DeleteOptions', '10': 'options'},
  ],
};

/// Descriptor for `DeleteRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode('Cg1EZWxldGVSZXF1ZXN0EjAKBGRhdGEYASADKAsyHC5zdGF0aWNfZ3JwYy5yZW50YWwuUmVudGFsUGtSBGRhdGESOwoHb3B0aW9ucxgCIAEoCzIhLnN0YXRpY19ncnBjLnJlbnRhbC5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  '1': 'SelectRequest',
  '2': const [
    const {'1': 'columns', '3': 1, '4': 3, '5': 14, '6': '.static_grpc.rental.SelectableColumns', '10': 'columns'},
    const {'1': 'where', '3': 2, '4': 1, '5': 9, '10': 'where'},
    const {'1': 'orderBy', '3': 3, '4': 3, '5': 11, '6': '.static_grpc.rental.OrderByOperator', '10': 'orderBy'},
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode('');
...
const SelectResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data', '3': 7, '4': 3, '5': 11, '6': '.static_grpc.rental.Rental', '10': 'data'},
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use rentalDescriptor instead')
const Rental$json = const {
  '1': 'Rental',
  '2': const [
    const {'1': 'rentalId', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.rental.IntegerValue', '10': 'rentalId'},
    const {'1': 'rentalDate', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.rental.StringValue', '10': 'rentalDate'},
    const {'1': 'inventoryId', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.rental.IntegerValue', '10': 'inventoryId'},
    const {'1': 'customerId', '3': 4, '4': 1, '5': 11, '6': '.static_grpc.rental.IntegerValue', '10': 'customerId'},
    const {'1': 'returnDate', '3': 5, '4': 1, '5': 11, '6': '.static_grpc.rental.StringValue', '10': 'returnDate'},
    const {'1': 'staffId', '3': 6, '4': 1, '5': 11, '6': '.static_grpc.rental.IntegerValue', '10': 'staffId'},
    const {'1': 'lastUpdate', '3': 7, '4': 1, '5': 11, '6': '.static_grpc.rental.StringValue', '10': 'lastUpdate'},
  ],
};

/// Descriptor for `Rental`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rentalDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List rentalPkDescriptor = $convert.base64Decode('CghSZW50YWxQaxI8CghyZW50YWxJZBgBIAEoCzIgLnN0YXRpY19ncnBjLnJlbnRhbC5JbnRlZ2VyVmFsdWVSCHJlbnRhbElk');
@$core.Deprecated('Use rentalToInsertDescriptor instead')
const RentalToInsert$json = const {
  '1': 'RentalToInsert',
  '2': const [
    const {'1': 'rentalDate', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.rental.StringValue', '10': 'rentalDate'},
    const {'1': 'inventoryId', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.rental.IntegerValue', '10': 'inventoryId'},
    const {'1': 'customerId', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.rental.IntegerValue', '10': 'customerId'},
    const {'1': 'returnDate', '3': 4, '4': 1, '5': 11, '6': '.static_grpc.rental.StringValue', '10': 'returnDate'},
    const {'1': 'staffId', '3': 5, '4': 1, '5': 11, '6': '.static_grpc.rental.IntegerValue', '10': 'staffId'},
    const {'1': 'lastUpdate', '3': 6, '4': 1, '5': 11, '6': '.static_grpc.rental.StringValue', '10': 'lastUpdate'},
  ],
};

/// Descriptor for `RentalToInsert`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rentalToInsertDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use orderByOperatorDescriptor instead')
const OrderByOperator$json = const {
  '1': 'OrderByOperator',
  '2': const [
    const {'1': 'column', '3': 1, '4': 1, '5': 14, '6': '.static_grpc.rental.SelectableColumns', '10': 'column'},
    const {'1': 'orderType', '3': 2, '4': 1, '5': 14, '6': '.static_grpc.rental.OrderType', '10': 'orderType'},
  ],
};

/// Descriptor for `OrderByOperator`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode('Cg9PcmRlckJ5T3BlcmF0b3ISPQoGY29sdW1uGAEgASgOMiUuc3RhdGljX2dycGMucmVudGFsLlNlbGVjdGFibGVDb2x1bW5zUgZjb2x1bW4SOwoJb3JkZXJUeXBlGAIgASgOMh0uc3RhdGljX2dycGMucmVudGFsLk9yZGVyVHlwZVIJb3JkZXJUeXBl');
