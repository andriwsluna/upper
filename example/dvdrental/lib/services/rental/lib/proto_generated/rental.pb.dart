  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<RentalToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: RentalToInsert.create)
    ..aOM<InsertOptions>(
...
class Rental extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Rental',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.rental'),
      createEmptyInstance: create)
    ..aOM<IntegerValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rentalId',
        protoName: 'rentalId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rentalDate',
        protoName: 'rentalDate', subBuilder: StringValue.create)
    ..aOM<IntegerValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inventoryId',
        protoName: 'inventoryId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId',
        protoName: 'customerId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'returnDate',
        protoName: 'returnDate', subBuilder: StringValue.create)
  ...
  factory Rental.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Rental.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  Rental copyWith(void Function(Rental) updates) =>
      super.copyWith((message) => updates(message as Rental))
          as Rental; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RentalPk extends $pb.GeneratedMessage {
  ...
  factory RentalPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RentalPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RentalPk copyWith(void Function(RentalPk) updates) =>
      super.copyWith((message) => updates(message as RentalPk))
          as RentalPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RentalPk getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RentalPk>(create);
...
class RentalToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RentalToInsert',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.rental'),
      createEmptyInstance: create)
    ..aOM<StringValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rentalDate',
        protoName: 'rentalDate', subBuilder: StringValue.create)
    ..aOM<IntegerValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inventoryId',
        protoName: 'inventoryId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId',
        protoName: 'customerId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'returnDate',
        protoName: 'returnDate', subBuilder: StringValue.create)
    ..aOM<IntegerValue>(
        5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staffId',
  ...
  factory RentalToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RentalToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RentalToInsert copyWith(void Function(RentalToInsert) updates) =>
      super.copyWith((message) => updates(message as RentalToInsert))
          as RentalToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RentalToInsert create() => RentalToInsert._();
  RentalToInsert createEmptyInstance() => create();
  static $pb.PbList<RentalToInsert> createRepeated() =>
      $pb.PbList<RentalToInsert>();
  @$core.pragma('dart2js:noInline')
  static RentalToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RentalToInsert>(create);
