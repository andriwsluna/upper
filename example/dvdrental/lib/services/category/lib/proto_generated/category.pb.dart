  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<CategoryToInsert>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: CategoryToInsert.create)
    ..aOM<InsertOptions>(
...
class Category extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoryId',
        protoName: 'categoryId', subBuilder: IntegerValue.create)
    ..aOM<StringValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name',
...
class CategoryPk extends $pb.GeneratedMessage {
  ...
  factory CategoryPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CategoryPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CategoryPk copyWith(void Function(CategoryPk) updates) =>
      super.copyWith((message) => updates(message as CategoryPk))
          as CategoryPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CategoryPk getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CategoryPk>(create);
...
class CategoryToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<StringValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name',
        subBuilder: StringValue.create)
    ..aOM<StringValue>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
  ...
  factory CategoryToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CategoryToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CategoryToInsert copyWith(void Function(CategoryToInsert) updates) =>
      super.copyWith((message) => updates(message as CategoryToInsert))
          as CategoryToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CategoryToInsert create() => CategoryToInsert._();
  CategoryToInsert createEmptyInstance() => create();
  static $pb.PbList<CategoryToInsert> createRepeated() =>
      $pb.PbList<CategoryToInsert>();
  @$core.pragma('dart2js:noInline')
  static CategoryToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CategoryToInsert>(create);
