...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASDgoKY2F0ZWdvcnlJZBABEgkKBW5hbWVfEAISDgoKbGFzdFVwZGF0ZRAD');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode(
    'CgpHZXRSZXF1ZXN0Eh4KCmNhdGVnb3J5SWQYASABKAVSCmNhdGVnb3J5SWQ=');
...
const GetResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.category.Category',
      '9': 0,
      '10': 'data'
    },
    const {
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBI0CgRkYXRhGAIgASgLMh4uc3RhdGljX2dycGMuY2F0ZWdvcnkuQ2F0ZWdvcnlIAFIEZGF0YRIkCgxlcnJvck1lc3NhZ2UYAyABKAlIAFIMZXJyb3JNZXNzYWdlQhMKEUdldFJlc3BvbnNlUmVzdWx0');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.category.CategoryToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.category.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0EjoKBGRhdGEYASADKAsyJi5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5DYXRlZ29yeVRvSW5zZXJ0UgRkYXRhEj0KB29wdGlvbnMYAiABKAsyIy5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.category.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EjIKBGRhdGEYASADKAsyHi5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5DYXRlZ29yeVIEZGF0YRI9CgdvcHRpb25zGAIgASgLMiMuc3RhdGljX2dycGMuY2F0ZWdvcnkuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.category.CategoryPk',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.category.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0EjQKBGRhdGEYASADKAsyIC5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5DYXRlZ29yeVBrUgRkYXRhEj0KB29wdGlvbnMYAiABKAsyIy5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.category.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.category.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Category$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.category.IntegerValue',
      '10': 'categoryId'
    },
    const {
      '1': 'name',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.category.StringValue',
      '10': 'name'
    },
    const {
      '1': 'lastUpdate',
...
final $typed_data.Uint8List categoryDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List categoryPkDescriptor = $convert.base64Decode(
    'CgpDYXRlZ29yeVBrEkIKCmNhdGVnb3J5SWQYASABKAsyIi5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5JbnRlZ2VyVmFsdWVSCmNhdGVnb3J5SWQ=');
...
final $typed_data.Uint8List categoryToInsertDescriptor = $convert.base64Decode(
    'ChBDYXRlZ29yeVRvSW5zZXJ0EjUKBG5hbWUYASABKAsyIS5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5TdHJpbmdWYWx1ZVIEbmFtZRJBCgpsYXN0VXBkYXRlGAIgASgLMiEuc3RhdGljX2dycGMuY2F0ZWdvcnkuU3RyaW5nVmFsdWVSCmxhc3RVcGRhdGU=');
...
const OrderByOperator$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.static_grpc.category.OrderType',
      '10': 'orderType'
    },
  ],
};
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISPwoGY29sdW1uGAEgASgOMicuc3RhdGljX2dycGMuY2F0ZWdvcnkuU2VsZWN0YWJsZUNvbHVtbnNSBmNvbHVtbhI9CglvcmRlclR5cGUYAiABKA4yHy5zdGF0aWNfZ3JwYy5jYXRlZ29yeS5PcmRlclR5cGVSCW9yZGVyVHlwZQ==');
