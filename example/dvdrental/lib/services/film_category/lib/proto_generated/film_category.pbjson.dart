...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode(
    'ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASCgoGZmlsbUlkEAESDgoKY2F0ZWdvcnlJZBACEg4KCmxhc3RVcGRhdGUQAw==');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode(
    'CgpHZXRSZXF1ZXN0EhYKBmZpbG1JZBgBIAEoBVIGZmlsbUlkEh4KCmNhdGVnb3J5SWQYAiABKAVSCmNhdGVnb3J5SWQ=');
...
const GetResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_category.Film_category',
      '9': 0,
      '10': 'data'
    },
    const {
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode(
    'CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBI+CgRkYXRhGAIgASgLMiguc3RhdGljX2dycGMuZmlsbV9jYXRlZ29yeS5GaWxtX2NhdGVnb3J5SABSBGRhdGESJAoMZXJyb3JNZXNzYWdlGAMgASgJSABSDGVycm9yTWVzc2FnZUITChFHZXRSZXNwb25zZVJlc3VsdA==');
...
const InsertRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.film_category.Film_categoryToInsert',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_category.InsertOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode(
    'Cg1JbnNlcnRSZXF1ZXN0EkQKBGRhdGEYASADKAsyMC5zdGF0aWNfZ3JwYy5maWxtX2NhdGVnb3J5LkZpbG1fY2F0ZWdvcnlUb0luc2VydFIEZGF0YRJCCgdvcHRpb25zGAIgASgLMiguc3RhdGljX2dycGMuZmlsbV9jYXRlZ29yeS5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_category.UpdateOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode(
    'Cg1VcGRhdGVSZXF1ZXN0EjwKBGRhdGEYASADKAsyKC5zdGF0aWNfZ3JwYy5maWxtX2NhdGVnb3J5LkZpbG1fY2F0ZWdvcnlSBGRhdGESQgoHb3B0aW9ucxgCIAEoCzIoLnN0YXRpY19ncnBjLmZpbG1fY2F0ZWdvcnkuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.film_category.Film_categoryPk',
      '10': 'data'
    },
    const {
      '1': 'options',
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_category.DeleteOptions',
      '10': 'options'
    },
  ],
};
...
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode(
    'Cg1EZWxldGVSZXF1ZXN0Ej4KBGRhdGEYASADKAsyKi5zdGF0aWNfZ3JwYy5maWxtX2NhdGVnb3J5LkZpbG1fY2F0ZWdvcnlQa1IEZGF0YRJCCgdvcHRpb25zGAIgASgLMiguc3RhdGljX2dycGMuZmlsbV9jYXRlZ29yeS5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.static_grpc.film_category.SelectableColumns',
      '10': 'columns'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.static_grpc.film_category.OrderByOperator',
      '10': 'orderBy'
    },
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode(
    '');
...
const Film_category$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_category.IntegerValue',
      '10': 'filmId'
    },
    const {
      '1': 'categoryId',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.static_grpc.film_category.StringValue',
      '10': 'lastUpdate'
    },
  ],
};
...
final $typed_data.Uint8List film_categoryDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List film_categoryPkDescriptor = $convert.base64Decode(
    'Cg9GaWxtX2NhdGVnb3J5UGsSPwoGZmlsbUlkGAEgASgLMicuc3RhdGljX2dycGMuZmlsbV9jYXRlZ29yeS5JbnRlZ2VyVmFsdWVSBmZpbG1JZBJHCgpjYXRlZ29yeUlkGAIgASgLMicuc3RhdGljX2dycGMuZmlsbV9jYXRlZ29yeS5JbnRlZ2VyVmFsdWVSCmNhdGVnb3J5SWQ=');
...
final $typed_data.Uint8List film_categoryToInsertDescriptor = $convert.base64Decode(
    '');
...
const OrderByOperator$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.static_grpc.film_category.OrderType',
      '10': 'orderType'
    },
  ],
};
...
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode(
    'Cg9PcmRlckJ5T3BlcmF0b3ISRAoGY29sdW1uGAEgASgOMiwuc3RhdGljX2dycGMuZmlsbV9jYXRlZ29yeS5TZWxlY3RhYmxlQ29sdW1uc1IGY29sdW1uEkIKCW9yZGVyVHlwZRgCIAEoDjIkLnN0YXRpY19ncnBjLmZpbG1fY2F0ZWdvcnkuT3JkZXJUeXBlUglvcmRlclR5cGU=');
