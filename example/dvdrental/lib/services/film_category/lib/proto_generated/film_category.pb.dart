...
class GetRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..a<$core.int>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filmId', $pb.PbFieldType.O3,
        protoName: 'filmId')
    ..a<$core.int>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoryId',
        $pb.PbFieldType.O3,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Film_category>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'data',
        subBuilder: Film_category.create)
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'static_grpc.film_category'),
      createEmptyInstance: create)
    ..pc<Film_categoryToInsert>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: Film_categoryToInsert.create)
    ..aOM<InsertOptions>(
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<Film_categoryPk>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: Film_categoryPk.create)
    ..aOM<DeleteOptions>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options',
...
class Film_category extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filmId',
        protoName: 'filmId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoryId',
        protoName: 'categoryId', subBuilder: IntegerValue.create)
  ...
  factory Film_category.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Film_category.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Film_category copyWith(void Function(Film_category) updates) =>
      super.copyWith((message) => updates(message as Film_category))
          as Film_category; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Film_category create() => Film_category._();
  Film_category createEmptyInstance() => create();
  static $pb.PbList<Film_category> createRepeated() =>
      $pb.PbList<Film_category>();
  @$core.pragma('dart2js:noInline')
  static Film_category getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Film_category>(create);
...
class Film_categoryPk extends $pb.GeneratedMessage {
  ...
  factory Film_categoryPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Film_categoryPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Film_categoryPk copyWith(void Function(Film_categoryPk) updates) =>
      super.copyWith((message) => updates(message as Film_categoryPk))
          as Film_categoryPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Film_categoryPk create() => Film_categoryPk._();
  Film_categoryPk createEmptyInstance() => create();
  static $pb.PbList<Film_categoryPk> createRepeated() =>
      $pb.PbList<Film_categoryPk>();
  @$core.pragma('dart2js:noInline')
  static Film_categoryPk getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Film_categoryPk>(create);
...
class Film_categoryToInsert extends $pb.GeneratedMessage {
  ...
  factory Film_categoryToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Film_categoryToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  Film_categoryToInsert clone() =>
      Film_categoryToInsert()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Film_categoryToInsert copyWith(
          void Function(Film_categoryToInsert) updates) =>
      super.copyWith((message) => updates(message as Film_categoryToInsert))
          as Film_categoryToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Film_categoryToInsert create() => Film_categoryToInsert._();
  Film_categoryToInsert createEmptyInstance() => create();
  static $pb.PbList<Film_categoryToInsert> createRepeated() =>
      $pb.PbList<Film_categoryToInsert>();
  @$core.pragma('dart2js:noInline')
  static Film_categoryToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Film_categoryToInsert>(create);
