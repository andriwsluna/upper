...
final $typed_data.Uint8List selectableColumnsDescriptor = $convert.base64Decode('ChFTZWxlY3RhYmxlQ29sdW1ucxIOCgphbGxDb2x1bW5zEAASDwoLaW52ZW50b3J5SWQQARIKCgZmaWxtSWQQAhILCgdzdG9yZUlkEAMSDgoKbGFzdFVwZGF0ZRAE');
...
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode('CgpHZXRSZXF1ZXN0EiAKC2ludmVudG9yeUlkGAEgASgFUgtpbnZlbnRvcnlJZA==');
@$core.Deprecated('Use getResponseDescriptor instead')
const GetResponse$json = const {
  '1': 'GetResponse',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 8, '10': 'result'},
    const {'1': 'data', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.inventory.Inventory', '9': 0, '10': 'data'},
...
final $typed_data.Uint8List getResponseDescriptor = $convert.base64Decode('CgtHZXRSZXNwb25zZRIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBI2CgRkYXRhGAIgASgLMiAuc3RhdGljX2dycGMuaW52ZW50b3J5LkludmVudG9yeUgAUgRkYXRhEiQKDGVycm9yTWVzc2FnZRgDIAEoCUgAUgxlcnJvck1lc3NhZ2VCEwoRR2V0UmVzcG9uc2VSZXN1bHQ=');
@$core.Deprecated('Use insertRequestDescriptor instead')
const InsertRequest$json = const {
  '1': 'InsertRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.inventory.InventoryToInsert', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.inventory.InsertOptions', '10': 'options'},
  ],
};

/// Descriptor for `InsertRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List insertRequestDescriptor = $convert.base64Decode('Cg1JbnNlcnRSZXF1ZXN0EjwKBGRhdGEYASADKAsyKC5zdGF0aWNfZ3JwYy5pbnZlbnRvcnkuSW52ZW50b3J5VG9JbnNlcnRSBGRhdGESPgoHb3B0aW9ucxgCIAEoCzIkLnN0YXRpY19ncnBjLmludmVudG9yeS5JbnNlcnRPcHRpb25zUgdvcHRpb25z');
...
const UpdateRequest$json = const {
  '1': 'UpdateRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.inventory.Inventory', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.inventory.UpdateOptions', '10': 'options'},
  ],
};

/// Descriptor for `UpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateRequestDescriptor = $convert.base64Decode('Cg1VcGRhdGVSZXF1ZXN0EjQKBGRhdGEYASADKAsyIC5zdGF0aWNfZ3JwYy5pbnZlbnRvcnkuSW52ZW50b3J5UgRkYXRhEj4KB29wdGlvbnMYAiABKAsyJC5zdGF0aWNfZ3JwYy5pbnZlbnRvcnkuVXBkYXRlT3B0aW9uc1IHb3B0aW9ucw==');
...
const DeleteRequest$json = const {
  '1': 'DeleteRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.static_grpc.inventory.InventoryPk', '10': 'data'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.inventory.DeleteOptions', '10': 'options'},
  ],
};

/// Descriptor for `DeleteRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteRequestDescriptor = $convert.base64Decode('Cg1EZWxldGVSZXF1ZXN0EjYKBGRhdGEYASADKAsyIi5zdGF0aWNfZ3JwYy5pbnZlbnRvcnkuSW52ZW50b3J5UGtSBGRhdGESPgoHb3B0aW9ucxgCIAEoCzIkLnN0YXRpY19ncnBjLmludmVudG9yeS5EZWxldGVPcHRpb25zUgdvcHRpb25z');
...
const SelectRequest$json = const {
  '1': 'SelectRequest',
  '2': const [
    const {'1': 'columns', '3': 1, '4': 3, '5': 14, '6': '.static_grpc.inventory.SelectableColumns', '10': 'columns'},
    const {'1': 'where', '3': 2, '4': 1, '5': 9, '10': 'where'},
    const {'1': 'orderBy', '3': 3, '4': 3, '5': 11, '6': '.static_grpc.inventory.OrderByOperator', '10': 'orderBy'},
...
final $typed_data.Uint8List selectRequestDescriptor = $convert.base64Decode('');
...
const SelectResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data', '3': 7, '4': 3, '5': 11, '6': '.static_grpc.inventory.Inventory', '10': 'data'},
...
final $typed_data.Uint8List selectResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use inventoryDescriptor instead')
const Inventory$json = const {
  '1': 'Inventory',
  '2': const [
    const {'1': 'inventoryId', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.inventory.IntegerValue', '10': 'inventoryId'},
    const {'1': 'filmId', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.inventory.IntegerValue', '10': 'filmId'},
    const {'1': 'storeId', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.inventory.IntegerValue', '10': 'storeId'},
    const {'1': 'lastUpdate', '3': 4, '4': 1, '5': 11, '6': '.static_grpc.inventory.StringValue', '10': 'lastUpdate'},
  ],
};

/// Descriptor for `Inventory`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List inventoryDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List inventoryPkDescriptor = $convert.base64Decode('CgtJbnZlbnRvcnlQaxJFCgtpbnZlbnRvcnlJZBgBIAEoCzIjLnN0YXRpY19ncnBjLmludmVudG9yeS5JbnRlZ2VyVmFsdWVSC2ludmVudG9yeUlk');
@$core.Deprecated('Use inventoryToInsertDescriptor instead')
const InventoryToInsert$json = const {
  '1': 'InventoryToInsert',
  '2': const [
    const {'1': 'filmId', '3': 1, '4': 1, '5': 11, '6': '.static_grpc.inventory.IntegerValue', '10': 'filmId'},
    const {'1': 'storeId', '3': 2, '4': 1, '5': 11, '6': '.static_grpc.inventory.IntegerValue', '10': 'storeId'},
    const {'1': 'lastUpdate', '3': 3, '4': 1, '5': 11, '6': '.static_grpc.inventory.StringValue', '10': 'lastUpdate'},
  ],
};

/// Descriptor for `InventoryToInsert`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List inventoryToInsertDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use orderByOperatorDescriptor instead')
const OrderByOperator$json = const {
  '1': 'OrderByOperator',
  '2': const [
    const {'1': 'column', '3': 1, '4': 1, '5': 14, '6': '.static_grpc.inventory.SelectableColumns', '10': 'column'},
    const {'1': 'orderType', '3': 2, '4': 1, '5': 14, '6': '.static_grpc.inventory.OrderType', '10': 'orderType'},
  ],
};

/// Descriptor for `OrderByOperator`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List orderByOperatorDescriptor = $convert.base64Decode('Cg9PcmRlckJ5T3BlcmF0b3ISQAoGY29sdW1uGAEgASgOMiguc3RhdGljX2dycGMuaW52ZW50b3J5LlNlbGVjdGFibGVDb2x1bW5zUgZjb2x1bW4SPgoJb3JkZXJUeXBlGAIgASgOMiAuc3RhdGljX2dycGMuaW52ZW50b3J5Lk9yZGVyVHlwZVIJb3JkZXJUeXBl');
