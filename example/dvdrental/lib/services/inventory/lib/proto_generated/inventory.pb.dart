  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'static_grpc.inventory'),
      createEmptyInstance: create)
    ..pc<InventoryToInsert>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'data',
        $pb.PbFieldType.PM,
        subBuilder: InventoryToInsert.create)
    ..aOM<InsertOptions>(
...
class Inventory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Inventory',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'static_grpc.inventory'),
      createEmptyInstance: create)
    ..aOM<IntegerValue>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inventoryId',
        protoName: 'inventoryId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filmId',
        protoName: 'filmId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storeId',
  ...
  @$pb.TagNumber(1)
  set inventoryId(IntegerValue v) {
    setField(1, v);
  }
...
class InventoryPk extends $pb.GeneratedMessage {
  ...
  factory InventoryPk.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InventoryPk.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InventoryPk copyWith(void Function(InventoryPk) updates) =>
      super.copyWith((message) => updates(message as InventoryPk))
          as InventoryPk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static InventoryPk getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InventoryPk>(create);
...
class InventoryToInsert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<IntegerValue>(
        ...
        protoName: 'filmId', subBuilder: IntegerValue.create)
    ..aOM<IntegerValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storeId',
        protoName: 'storeId', subBuilder: IntegerValue.create)
  ...
  factory InventoryToInsert.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InventoryToInsert.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InventoryToInsert copyWith(void Function(InventoryToInsert) updates) =>
      super.copyWith((message) => updates(message as InventoryToInsert))
          as InventoryToInsert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InventoryToInsert create() => InventoryToInsert._();
  InventoryToInsert createEmptyInstance() => create();
  static $pb.PbList<InventoryToInsert> createRepeated() =>
      $pb.PbList<InventoryToInsert>();
  @$core.pragma('dart2js:noInline')
  static InventoryToInsert getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InventoryToInsert>(create);
